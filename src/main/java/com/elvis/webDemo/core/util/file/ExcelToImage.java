...
public class ExcelToImage {
	...
	public static void test(String path,String output) throws Exception {
		...
		for (int i = 0; i < totalRow; i++) {
			for (int j = 1; j < totalCol; j++) {
				...
				if (cell != null) {
					...
					if (cs.getDataFormatString()!=null&&cs.getDataFormatString().contains("0.00%")) {
						try {
	...
	public static void main(String[] args) throws Exception {
		String path = "d:/cecsysProject/智慧用电项目/智慧用点项目功能缺失(1).xlsx";
		test(path,"d:/doc/test2.png");
	}
